...
async fn lul(tmpl_env: MiniJinjaRenderer) -> actix_web::Result<impl Responder> {
    tmpl_env.render("lul.html", ())
}
...
async fn main() -> std::io::Result<()> {
    ...
    let tmpl_reloader = AutoReloader::new(move |notifier| {
        ...
        let tmpl_path = PathBuf::from("./templates");
    ...
    HttpServer::new(move || {
        App::new()
            ...
            .service(web::resource("/lul").route(web::get().to(lul)))
